import { pgTable, uuid, varchar, text, boolean, integer, real, numeric, timestamp, jsonb, uniqueIndex, index, customType, } from 'drizzle-orm/pg-core';
...
export const heatmapCells = pgTable('heatmap_cells', {
    id: uuid('id').primaryKey().defaultRandom(),
